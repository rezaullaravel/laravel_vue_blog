                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form @submit.prevent="updateBlog">
                                ...
                                <div class="form-group">
                                    <label>Image</label>
                                    <input type="file" name="image" @change="handleFile" class="form-control">
                                    <img  :src="imagePreview == null ? '../../'+form.image : imagePreview" width="150px" />
...
import Form from 'vform'
 ...
 export default{
    ...
    mounted(){
            ...
            //console.log(id);
            axios.get('/get/blogById/'+id)
           .then((response)=> {
           // this.form.image = response.data.blog.image;
            //console.log(response);
            //this.form.category_id = response.data.blog.category_id;
    ...
    methods:{
        async updateBlog(){
         ...
         let id = this.$route.params.id;
         await this.form.post('/update/blog/'+id)
