<div class="footer">
    <div class="footer_grides">
     ...
     <div class="tweet_img">
         <img src="{{asset('/')}}frontend/images/tweet-img1.jpg" alt=""/>
 </div>
 ...
 <div class="tweet_data">
     <div class="tweet_img">
         <img src="{{asset('/')}}frontend/images/tweet-img2.jpg" alt=""/>
 </div>
 <div class="tweet_desc">
 ...
 <div class="tweet_data">
     <div class="tweet_img">
         <img src="{{asset('/')}}frontend/images/tweet-img3.jpg" alt=""/>
 </div>
 <div class="tweet_desc">
      <h4>May 4th, 2013</h4>
 <p>Integer eget tortor et elit venenatis auctor morbi turpis nulla</p>
 ...
 <div class="footer_grid3">
     <h3>Follow</h3>
         <div class="social_icons">
             <div class="img_list">
                 <ul>
                  <li><img src="{{asset('/')}}frontend/images/facebook.png" alt="" /><a href="#">Facebook</a></li>
                  <li><img src="{{asset('/')}}frontend/images/google+.png" alt="" /><a href="#">Google Plus</a></li>
                  <li><img src="{{asset('/')}}frontend/images/twitter.png" alt="" /><a href="#">Twitter</a></li>
                  <li><img src="{{asset('/')}}frontend/images/linkedin.png" alt="" /><a href="#">Likedin</a></li>
                 </ul>
             </div>
         </div>
  </div>
